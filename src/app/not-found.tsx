...
// ১. মূল কন্টেন্ট Component (যার ভেতর useSearchParams থাকবে)
function NotFoundContent() {
  const router = useRouter();
  // const searchParams = useSearchParams(); // searchParams যুক্ত করা হলো
  // const redirectPath = searchParams.get("from"); // প্রয়োজন অনুযায়ী ব্যবহার করতে পারেন
